...
}}std::ostream &operator<<(std::ostream &s, Color x){return s << fmt::to_string(x);}}// namespace FlexFlow
...
namespace rc{Gen<FlexFlow::Color> Arbitrary<FlexFlow::Color>::arbitrary(){return gen::element<FlexFlow::Color>(FlexFlow::Color::RED, FlexFlow::Color::BLUE, FlexFlow::Color::YELLOW);}}// namespace rc
'''
